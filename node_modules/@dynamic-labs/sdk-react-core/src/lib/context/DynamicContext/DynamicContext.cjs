...
var sessionStorage = require('../../utils/constants/sessionStorage.cjs');
require('yup');
...
var TelegramAutoLogin = require('../../components/TelegramAutoLogin/TelegramAutoLogin.cjs');
...
const InnerDynamicContextProvider = ({ children, theme, settings: settings$1, locale: locale$1, enableInstrumentation = false, }) => {
    ...
    const [authMode, setAuthMode] = useLocalStorage.useLocalStorage(localStorage.AUTH_MODE, initialAuthenticationMode);
    ...
    useSetWalletConnectorFetchers.useSetWalletConnectorFetchers(walletConnectorOptions$1, environmentId);
    ...
    const removeSessionStorageSessionKeys = () => {
        utils.StorageService.removeItem(sessionStorage.SECURE_ENCLAVE_WALLET_SESSION_KEYS, sessionStorage.SECURE_ENCLAVE_WALLET_SESSION_KEYS_STORAGE_OPTIONS);
